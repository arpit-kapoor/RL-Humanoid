...
public class MJRemote : MonoBehaviour 
{
    ...
    //new vars
    public UnityEngine.Transform humanoid_pos;
    public UnityEngine.Transform maze_agent_pos;
    public bool move_maze = false;
    public bool ag_reset = false;
